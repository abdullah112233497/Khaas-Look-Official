  ...
  <div className="md:hidden relative" ref={menuRef}>
    ...
    >
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 sm:px-12 py-12">
        ...
        >
          <Image src="/Fashion_Khaas.png" alt="Fashion Model" width={550} height={550} className="rounded-xl " />
        </motion.div>
      </section>
      ...
      <div className="flex justify-center px-4 mb-10">
        <input
          ...
          className="w-full max-w-md px-4 py-3 rounded-full border border-gray-300 bg-white text-black shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        />
      </div>
      ...
      <footer className="bg-white border-t mt-10 py-8 px-6 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-4">
          <a href="https://www.facebook.com/share/1FdjigndyY/" target="_blank" rel="noopener noreferrer">
            <Image className="hover:scale-125 transition-transform"  src="/icons/facebook.svg" alt="Facebook" width={28} height={28} />
          </a>
          <a href="https://www.instagram.com/khaaslook" target="_blank" rel="noopener noreferrer">
            <Image className="hover:scale-125 transition-transform"  src="/icons/instagram.svg" alt="Instagram" width={28} height={28} />
          </a>
          <a href="https://wa.me/923032966692" target="_blank" rel="noopener noreferrer">
            <Image className="hover:scale-125 transition-transform"  src="/icons/whatsapp.svg" alt="WhatsApp" width={28} height={28} />
          </a>
          <a href="https://www.tiktok.com/@khaaslook" target="_blank" rel="noopener noreferrer">
            <Image className="hover:scale-125 transition-transform" src="/icons/tiktok.svg" alt="TikTok" width={28} height={28}  />
          </a>
        </div>
